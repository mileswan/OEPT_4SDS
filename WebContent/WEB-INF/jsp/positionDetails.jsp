 ...
 * Version: 1.0
 * Date: 2015/09/06
 * Description:  User position details management page.
 */
-->
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<%=path%>/position/details.do?id=1">职位详细信息</a>
					</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" class="form-control" placeholder="请输入职位名称…" name="name" id="name" value="信息操作员">													
														</div>
													</div>
													<div class="col-md-6">
														<div class="form-group">
															...
															<textarea class="form-control" rows="3"
																placeholder="输入描述…" id="description">负责媒体信息的创建、维护、发布等</textarea>
															</div>
													</div>
												</div>
												<!--/row-->
														...
														<div class="form-group">
															<div class="theme-option">
																...
																<select class="form-control">
																	<option selected="selected">信息管理员</option>
																	<option >区域经理</option>
																	<option >大区经理</option>
																</select>
															</div>				
													...
													<div class="col-md-6">
														<div class="form-group">
															<p class="form-control-static">
																最近一次修改时间是在2015-10-09 13:30:55</p>
														</div>
													</div>
												</div>
											</div>
