										...
										<form class="form-horizontal">								
											...
											<div class="alert alert-success display-hide"
												...
												<div class="form-group">
													...
													<div class="col-md-4">															
														<input type="text" class="form-control input-circle" placeholder="姓氏" value="${lastname}" id="lastname">
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label">名字</label>
													<div class="col-md-4">
														<input type="text" class="form-control input-circle" placeholder="名字" value="${firstname}" id="firstname">
													</div>
												</div>	
												<div class="form-group">
													...
													<div class="col-md-4">
														<div class="input-group">
															...
															<input type="email" class="form-control input-circle-right" placeholder="电子邮箱" value="${emailAddress}" id="emailAddress">
														</div>
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label">接受电子邮件警告：</label>
													<div class="col-md-4 inlineEdit">
													<span class="button-group receiveEmailAlerts">
														<button data-value="true" class="${receiveEmailAlerts_true}">是</button>
														<button data-value="false" class="${receiveEmailAlerts_false}">否</button>
													</span>
													</div>											  
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label">接收批准通知电子邮件：</label>
													<div class="col-md-4 inlineEdit">
											...
											<div class="form-actions">
												<div class="row">
													<div class="col-md-offset-3 col-md-9">
														<button type="button" class="btn btn-circle blue" id="updateSettings-confirm">确认</button>
														<button type="button" class="btn btn-circle default cancel" id="updateSettings-restore">取消</button>
													</div>
												</div>
											</div>
										</form>
