...
public class PositionAct {
	...
	private static final Log logger = LogFactory.getLog(PositionAct.class);
	
	@RequestMapping(value="/list.do")
	public String navToPositionsList(Model model, HttpServletRequest request, HttpSession session, HttpServletResponse response) throws Exception{
