 ...
 * Version: 1.0
 * Date: 2015/09/05
 * Description:  Position list management page.
 */
-->
		...
		<div class="page-content">
					...
					<div class="modal-content">
						...
						<div class="row">
							<div class="col-md-6">
								...
								<input type="text" class="form-control" placeholder="请输入职位名…" id="position-name">
								<label>描述</label>
							...
							<select class="form-control">
								<option value="SCALA" selected="selected">信息管理员</option>
								<option value="ANDROID_TYPE_1">区域管理员</option>
								<option value="IADEA_SD">大区经理</option>
							</select>
							</div>
							</div>
						</div>
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<%=path%>/position/list.do">职位管理</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
						<a href="<%=path%>/position/list.do">职位列表</a>
					</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
					...
					<div class="portlet box grey-cascade">
						...
						<div class="portlet-body">
	                		...
	                		<tr class="odd gradeX">
	                    		...
	                    		<td id="1"><a href="<%=path%>/position/details.do?id=1">信息操作员</a></td>
	                    		<td>  
	                    			负责媒体信息的创建、维护、发布等   		
								</td>
	                    		<td>
							...
							<tr class="odd gradeX">
	                    		...
	                    		<td id="2"><a href="<%=path%>/position/details.do?id=2">信息管理员</a></td>
	                    		<td>  
	                    			负责媒体信息的审批		
								</td>
	                    		<td>
	                  		...
	                  		<tr class="odd gradeX">
	                    		...
	                    		<td id="3"><a href="<%=path%>/position/details.do?id=3">区域管理员</a></td>
	                    		<td>  
	                    			负责媒体营销终端区域的管理工作		
								</td>
	                    		<td>
