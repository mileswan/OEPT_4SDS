		...
		<div class="page-content">
			...
			<div class="modal fade bs-modal-lg" id="new-confirm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				<div class="modal-dialog bs-modal-lg">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
							<h4 class="modal-title">新建用户角色</h4>
						</div>
						<div class="modal-body">
						<div class="row">
							<div class="col-md-6">
								<label class="control-label">角色名称：</label>
								<input type="text" class="form-control" placeholder="请输入名称…" id="rolename">
								<label>描述</label>
							...
							<select class="form-control">
								<option value="SCALA" selected="selected">系统</option>
								<option value="ANDROID_TYPE_1">维护</option>
								<option value="IADEA_SD">管理</option>
							</select>
							</div>
							</div>
						</div>
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<%=path%>/role/list.do">权限管理</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
						<a href="<%=path%>/role/list.do">角色列表</a>
					</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
					...
					<div class="portlet box grey-cascade">
						...
						<div class="portlet-body">
	                		...
	                		<tr class="odd gradeX">
	                    		...
	                    		<td id="${role.id}"><a href="<%=path%>/role/details.do?roleId=${role.id}">${role.id}</a></td>
	                    		<td>${role.name}                   		
								</td>
	                    		<td>        								
	                    		</td>
