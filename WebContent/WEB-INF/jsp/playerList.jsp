 ...
 * Version: 1.0
 * Date: 2015/08/10
 * Description:  player list management page.
 */
-->
		...
		<div class="page-content">
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<select class="form-control">
								...
								<option value="ANDROID_TYPE_1">安卓</option>
								<option value="IADEA_SD">Iadea</option>
							</select>
							</div>
						</div>
						<div class="modal-footer">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<%=path%>/player/list.do">播放器管理</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
					...
					<div class="portlet box grey-cascade">
						...
						<div class="portlet-body">
	                		...
	                		<tr class="odd gradeX">
	                    		...
	                    		<td>名称：<a href="<%=path%>/player/details.do?playerId=${player.id}">${player.name}</a><br>
	                    		类型：
	                    		<c:choose>
	                    		...
	                    		<td>
	                    		<c:forEach var="playerDisplay" items="${player.playerDisplays}">
	                    			<a href="<%=path%>/channel/details.do?channelId=${playerDisplay.channel.id}">${playerDisplay.channel.name}</a>
	                    		</c:forEach>            								
	                    		</td>
	                    		<td>
	                    		${player.lastModified}
