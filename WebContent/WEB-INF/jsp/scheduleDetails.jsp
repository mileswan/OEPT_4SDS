 ...
 * Version: 1.0
 * Date: 2015/09/06
 * Description:  Schedule Detail view details management page.
 */
-->
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<%=path%>/schedule/details.do?channelId=${channelId}">计划详细信息</a>
					</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
			...
			<div class="row">
				...
				<div class="tabbable tabbable-custom boxless tabbable-reversed">
						...
						<div class="tab-content">
							...
							<div class="display-hide" style="display: none;" id="channelType">${channelDetail.type}</div>
