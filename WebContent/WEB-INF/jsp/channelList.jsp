...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<br>
							<label id="selectedName">框架集名称：<a></a></label>
							<a href="#add-frameset" data-toggle="modal" class="btn green">
													<i class="fa fa-plus"></i> 选择框架集
							</a>
						</div>
						<div class="modal-footer">
			...
			<!-- BEGIN ADD FRAMESET CONFIRM MODAL FORM -->
			<div class="modal fade bs-modal-lg" id="add-frameset" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				<div class="modal-dialog modal-lg">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
							<h4 class="modal-title">选择框架集</h4>
						</div>
						<div class="modal-body">
							...
							<tbody>	
							<!-- Added table content from api javascript -->			
							</tbody>
							</table>
						</div>
						<div class="modal-footer">
							<button type="button" id="addFrameSet-confirm" class="btn blue" data-dismiss="modal">确认</button>
							<button type="button" class="btn default" data-dismiss="modal">取消</button>
						</div>
					</div>
					<!-- /.modal-content -->
					...
					<div class="portlet box grey-cascade">
						...
						<div class="portlet-body">
	                		...
	                		<tr class="odd gradeX">
	                    		...
	                    		<td id="${channel.id}">${channel.id}</td>
	                    		...
	                    		<td>
	                    			<a href="<%=path%>/frameset/details.do?frameSetId=${channel.frameset.id}">${channel.frameset.name}</a>	                    		                 								
	                    		</td>
	                    		<td>
	                    		${channel.lastModified}
	                    		</td>
	                    		<td>屏幕尺寸：${channel.frameset.width} x ${channel.frameset.height}<br>
