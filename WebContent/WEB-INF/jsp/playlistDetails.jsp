 ...
 * Version: 1.0
 * Date: 2015/08/27
 * Description:  Playlist details management page.
 */
-->
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		...
		<!-- BEGIN SAMPLE PORTLET CONFIGURATION MODAL FORM-->
			...
			<!-- BEGIN SAMPLE PORTLET CONFIGURATION MODAL FORM-->
			<div class="modal fade bs-modal" id="item-config" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
							<h4 class="modal-title">编辑媒体项目属性</h4>
						</div>
						<div class="modal-body">
							 <!--/row-->
								<div class="row">
								...
								<div class="row">
									<div class="col-md-3">
										<div class="form-group">
											...
											<div class="inlineEdit">
												<span class="button-group enabled">
													<button data-value="true" class="${enable_true}">激活</button>
													<button data-value="false" class="${enable_false}">禁用</button>
												</span>
											</div>
										</div>
									</div>
								...
								<div class="row">
									<div class="col-md-6">
									<label class="control-label">持续时间 (HH:mm:ss)：</label>
									<input class="form-control mask_duration" type="text" value="00:00:10" id="imageDuration">
									</div>
								</div>	
						</div>
						<div class="modal-footer">
							<button type="button" id="addMedia-confirm" class="btn blue" data-dismiss="modal">确认</button>						
							<button type="button" class="btn default" data-dismiss="modal">取消</button>
						</div>
					</div>
					<!-- /.modal-content -->
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<%=path%>/playlist/list.do">媒体编排列表</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
						<a href="<%=path%>/playlist/details.do?playlistId=${playlistId}">编排详细信息</a>
					</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
										...
										<form action="#" class="horizontal-form">
											<div class="form-body">
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" class="form-control" placeholder="请输入名称…" name="name" id="name" value="${playlistDetail.name}">													
														</div>
													</div>
												</div>
												<!--/row-->
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label">默认图像持续时间 (HH:mm:ss)：</label>
															<input class="form-control mask_duration" type="text" value="${playlistDetail.calImageDuration}" id="imageDuration">												
														</div>
													</div>
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label">默认网页/小组件持续时间 (HH:mm:ss)：</label>
															<input class="form-control mask_duration" type="text" value="${playlistDetail.calHtmlDuration}" id="htmlDuration">												
														</div>
													</div>
												</div>
												<!--/row-->
													...
													<div class="col-md-6">
														<div class="form-group">
															<p class="form-control-static">由
																${playlistDetail.createdBy.username}
																在 ${playlistDetail.createdDate} 创建</p>
														</div>
													</div>
												</div>
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															<p class="form-control-static">上次由
																${playlistDetail.modifiedBy.username}
																在 ${playlistDetail.lastModified} 修改</p>
														</div>
													</div>
												</div>
											</div>
									...
									<div class="portlet box blue">
										<div class="portlet-title">
											...
											<div class="actions">
												...
												<a href="#item-config" data-toggle="modal" class="btn yellow"> <i class="fa fa-pencil"></i>
													编辑项属性
												</a> 
