 ...
 * Version: 1.0
 * Date: 2015/09/05
 * Description:  Workgroup list management page.
 */
-->
		...
		<div class="page-content">
			...
			<div class="modal fade bs-modal-lg" id="new-confirm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				<div class="modal-dialog bs-modal-lg">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
							<h4 class="modal-title">新建工作组</h4>
						</div>
						<div class="modal-body">
						<div class="row">
							<div class="col-md-6">
								<label class="control-label">工作组名称：</label>
								<input type="text" class="form-control" placeholder="请输入工作组名…" id="workgroup-name">
								<label>描述</label>
								<textarea class="form-control" rows="2"	placeholder="输入描述…" id="description"></textarea>
							</div>
							<div class="col-md-6">
								<div class="theme-option">
							<label class="control-label">上级工作组：</label>
							<select class="form-control">
								<option value="SCALA" selected="selected">工作组A</option>
								<option value="ANDROID_TYPE_1">工作组B</option>
								<option value="IADEA_SD">工作组C</option>
							</select>
							</div>
							</div>
						</div>
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<%=path%>/workgroup/list.do">工作组管理</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
					...
					<div class="portlet box grey-cascade">
						...
						<div class="portlet-body">
	                		...
	                		<tr class="odd gradeX">
	                    		...
	                    		<td id="1"><a href="<%=path%>/workgroup/details.do?id=1">A部门工作组</a></td>
	                    		<td>  
	                    			A部门的工作组   		
								</td>
	                    		<td>
							...
							<tr class="odd gradeX">
	                    		...
	                    		<td id="2"><a href="<%=path%>/workgroup/details.do?id=2">B部门工作组</a></td>
	                    		<td>  
	                    			B部门的工作组		
								</td>
	                    		<td>
	                  		...
	                  		<tr class="odd gradeX">
	                    		...
	                    		<td id="3"><a href="<%=path%>/workgroup/details.do?id=3">C部门工作组</a></td>
	                    		<td>  
	                    			C部门的工作组	
								</td>
	                    		<td>
