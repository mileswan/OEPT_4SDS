										...
										<form action="#" class="horizontal-form">
											<div class="form-body">
												...
												<div class="row">
													<div class="col-md-3">
														<div class="form-group">
															...
															<input type="text" class="form-control" placeholder="请输入虚拟目录…" name="playerName" id="playerName" value="/OEPT_UIC">													
														</div>
													</div>
												</div>
												<!--/row-->
												<div class="row">
													...
													<div class="col-md-3">
														<div class="form-group">
															<label class="control-label">启用媒体项审批：</label>
															<div class="inlineEdit">
																<span class="button-group enabled">
																	<button data-value="true" class="${enable_true}">是</button>
																	<button data-value="false"
												...
												<div class="row">
													<div class="col-md-3">
														<div class="form-group">
															...
															<div class="inlineEdit">
																<span class="button-group enabled">
																	<button data-value="true" class="${enable_true}">启用</button>
																	<button data-value="false"
																		class="${enable_false}">禁用</button>
																</span>
															</div>
														</div>
													</div>
												...
												<div class="row">
													<div class="col-md-3">
														<div class="form-group">
															...
															<input type="text" class="form-control" placeholder="请输入服务器地址…" name="playerName" id="playerName" value="smtp@oept.com.cn">													
														</div>
													</div>
													<div class="col-md-3">
														<div class="form-group">
															<label class="control-label">端口：</label>
															<input type="text" class="form-control" placeholder="请输入端口号…" name="playerName" id="playerName" value="25">													
														</div>
													</div>
												</div>
												<!--/row-->
												<div class="row">
													<div class="col-md-3">
														<div class="form-group">
															...
															<input type="text" class="form-control" placeholder="请输入用户名…" name="playerName" id="playerName" value="oept_uic">													
														</div>
													</div>
													<div class="col-md-3">
														<div class="form-group">
															<label class="control-label">邮件发件人地址：</label>
															<input type="text" class="form-control" placeholder="请输入发件人地址…" name="playerName" id="playerName" value="oept_uic@oept.com.cn">													
														</div>
													</div>
												</div>
												<!--/row-->
											...
											<div class="form-body">
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															<p class="form-control-static">
																应用程序目录：C:/Program Files/Apache Software Foundation/Tomcat 7.0/webapps/OEPT_UIC</p>
														</div>
													</div>
													<div class="col-md-6">
														<div class="form-group">
