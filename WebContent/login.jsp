...
<!-- BEGIN LOGO -->
<div class="logo">
	<img src="assets/admin/layout/img/logo-login.png" style="height: 40px;" alt=""/>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
	...
	<form class="login-form" method="post">
		...
		<span class="form-title">欢迎登陆.</span></div>
		...
		<div class="form-actions">
			<button type="button" class="btn btn-primary btn-block uppercase">登陆</button>
		</div>
		<div class="form-actions">
			<div class="pull-left">
...
<div class="copyright hide">
	 2015 © OEPT. Universal Information Center.
</div>
<!-- END LOGIN -->
...
jQuery(document).ready(function() {     
    ...
    $('.login-form input').keypress(function(e) {
    	if (e.which == 13 && Login.getStatus() == false){
